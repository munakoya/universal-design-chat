      ...
      Modal: () => {
        return (
          <div className="modal_rule" id="overlay">
            <h2>利用規約</h2>
            <h3>
              この利用規約（以下，「本規約」という。）は，UDC（以下，「当サイト」という。）がこのウェブサイト上で提供するサービス（以下，「本サービス」という。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」という。）には，本規約に従って，本サービスをご利用いただきます。
            </h3>

            <h3>第1条（適用）</h3>
            <p>
              本規約は，ユーザーと当サイトとの間の本サービスの利用に関わる一切の関係に適用されるものとします。
              当サイトは本サービスに関し，本規約のほか，ご利用にあたってのルール等，各種の定め（以下，「個別規定」という。）をすることがあります。これら個別規定はその名称のいかんに関わらず，本規約の一部を構成するものとします。
            ...
            <p>
              ...
              他のユーザーに成りすます行為
              当サイトのサービスに関連して，反サイト会的勢力に対して直接または間接に利益を供与する行為
